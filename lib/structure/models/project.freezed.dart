...
class _$ProjectImpl extends _Project {
  ...
  @override
  String toString() {
    return 'Project(name: $name, description: $description, url: $url, from: $from, to: $to, responsibilities: $responsibilities)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, name, description, url, from, to,
...
abstract class _Project extends Project {
  const factory _Project(
      ...
      final String from,
      final String to,
      final List<String> responsibilities}) = _$ProjectImpl;
